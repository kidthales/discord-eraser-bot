...
class UserDemoteCommandTest extends KernelTestCase
{
    ...
    {
        return self::getCommandTester('app:user:demote');
    }
    ...
    {
        $user = UserTest::getSubject(175928847299117063, [User::ROLE_SUPER_ADMIN]);
        ...
        self::assertStringNotContainsString(User::ROLE_SUPER_ADMIN, $display);
    }
}
